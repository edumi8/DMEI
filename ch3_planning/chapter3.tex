...
\begin{itemize}
    \item \textbf{Constraint-to-design mapping:} constraints (e.g., limited privileges, heterogeneous execution environments) are mapped to explicit architectural and implementation decisions.
