...
This chapter presents how the dissertation project will be carried out during execution (January--June 2026). Building on the problem framing in Chapter~\ref{chap:Chapter1} and state of the art in Chapter~\ref{chap:Chapter2}, the focus is on methodological approach, planned artifacts, evaluation activities, skills development, schedule, and risk management.

\section{Objectives and Scope Alignment}

The project objectives and scope defined in Chapter~\ref{chap:Chapter1} remain aligned with findings synthesized in Chapter~\ref{chap:Chapter2}. No scope changes are planned. The work focuses on execution strategy to deliver planned artifacts and produce defensible evidence.

\section{Methodological Approach}
\label{sec:ch3_method}

The project is an engineering-oriented research effort centered on design, implementation, and evaluation of a container-first observability solution operating under practical constraints identified in Chapter~\ref{chap:Chapter1}. The approach is pragmatic and iterative: requirements and constraints inform successive design decisions, validated through controlled experimentation and practitioner feedback.
