...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{itemize}
    \item \textbf{Architectural choices}: multiple instrumentation patterns available
    \item \textbf{Telemetry integration}: across CI/CD services
  ...
  \begin{itemize}
    \item \textbf{Docker access}: leveraging container capabilities
    \item \textbf{Trade-off analysis}: overhead vs visibility
    \item \textbf{Diagnosis}: improving on-prem observability
  \end{itemize}
  \end{block}
\end{columns}

\vspace{0.4em}
\textbf{Scope:} heterogeneous containerized CI/CD on mixed OS
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{itemize}
    \item \textbf{Cloud platforms}: managed observability
    \item \textbf{Kubernetes focus}: native patterns
    \item \textbf{Homogeneous}: single OS environments
  \end{itemize}
  \end{block}
  ...
  \begin{itemize}
    \item \textbf{On-premise}: mixed OS deployments
    \item \textbf{CI/CD workloads}: limited comparative evaluation
    \item \textbf{Trade-offs}: instrumentation alternatives underexplored
  \end{itemize}
  \end{block}
\end{columns}
\end{frame}
...
\begin{block}{Central question}
  ...
  \textbf{heterogeneous containerized CI/CD} environments, and what are the \textbf{trade-offs} between different instrumentation approaches?
\end{block}

\begin{block}{Objectives}
  \begin{itemize}
    \item \textbf{Architecture}: comparative analysis of instrumentation patterns
    \item \textbf{Prototype}: reproducible images + deployment templates
    \item \textbf{Evaluation}: controlled fault injection + overhead characterization
  \end{itemize}
\end{block}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{itemize}
    \item \textbf{Problem framing}: heterogeneous containerized CI/CD
