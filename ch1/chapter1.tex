...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{ch1/assets/current_architecture_baseline.png}
    \caption{Current \ac{CICD} platform design baseline: distributed containerized services across four hosts with reactive, manual diagnostics and no integrated telemetry pipeline.}
    \label{fig:current-architecture-baseline}
\end{figure}

Figure~\ref{fig:current-architecture-baseline} summarizes the current design baseline considered in this research: services are distributed across four hosts and operational visibility depends on manual per-service inspection instead of centralized metrics, logs and traces. This baseline motivates the architecture work developed in subsequent chapters.
