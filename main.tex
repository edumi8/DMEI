...
% IEEE citation style (numeric, IEEE formatting)
\usepackage[style=ieee,backend=biber]{biblatex} % Biblatex with the IEEE style (numeric citations, IEEE bibliography format)
...
% \makeglossaries % build the glossary -- commented out as main glossary is empty; uncomment when adding glossary entries

%----------------------------------------------------------------------------------------
%	THESIS INFORMATION
%----------------------------------------------------------------------------------------

% Working title — update if you prefer a different one
\thesistitle{CI/CD Observability in Containerized Environments} % Your thesis title, this is used in the title, print it elsewhere with \ttitle

%\thesissubtitle{{[}Thesis Subtitle{]}} % Your thesis title, this is used in the title, print it elsewhere with \tsubtitle

% Replace with your full name as you want it to appear on the title page

\author{Eduardo \textsc{Sousa} } % Your name, this is used in the title page, print it elsewhere with \authorname
...
\advisor{Dr. Alexandre \textsc{Bragança}} % Your advisors's (academic mentor) name, this is used in the title page, print it elsewhere with \advname
...
\supervisor{Dr. Joao \textsc{Silva}} % Your supervisor's (company, hosting institution mentor) name, this is used in the title page, print it elsewhere with \supname (comment, if no supervisor, or same as advisor)
...
\keywords{CI/CD, Observability, Containers, Tracing, Logging, Monitoring} % Define up to 6 keywords that better describe your work

% Update the university/department links if necessary
\university{\href{https://www.isep.ipp.pt}{Instituto Superior de Engenharia do Porto (ISEP)}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname

\department{\href{https://www.dei.isep.ipp.pt}{DEI / ISEP -- Department of Electronic and Industrial Engineering}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
\input{ch1/chapter1}
\input{ch2_literature/chapter2}
\input{ch3_planning/chapter3}
\input{ch4_conclusion/chapter4}
