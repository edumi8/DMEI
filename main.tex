...
\usepackage[style=apa,backend=biber]{biblatex} % Biblatex with the APA style (author-year citations, APA bibliography format)
...
\input{ch1/chapter1}
\input{ch2_current_state/chapter2}
\input{ch2_literature/chapter2}
\input{ch3_planning/chapter3}
\input{ch4_design/chapter4}
\input{ch5_implementation/chapter5}
\input{ch6_evaluation/chapter6}
\input{ch5_conclusion/chapter5}
